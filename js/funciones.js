...
function pintarTarea(pTarea) {
    ...
    if (pTarea.prioridad.toLowerCase() === 'diario') {
        divTareasPending.style.backgroundColor = 'red';
    } else if (pTarea.prioridad.toLowerCase() === 'mensual') {
        divTareasPending.style.backgroundColor = 'blue';
    } else {
        divTareasPending.style.backgroundColor = 'green'
    }
